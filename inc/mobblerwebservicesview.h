...
#ifndef __MOBBLERWEBSERVICESVIEW_H__
#define __MOBBLERWEBSERVICESVIEW_H__
...
class CMobblerWebServicesView : public CAknView
	{
public:
	static CMobblerWebServicesView* NewL();
